...
class MoviesBloc extends Bloc<MoviesEvent, MoviesState>{
  ...
  MoviesBloc() : super(const MoviesState()){
    ...
    on<GetNowPlayingMovieEvent>((event, emit) async {
      ...
      MoviesRepository movieRepository = MoviesRepositoryImpl(remoteMovieDataSource: remoteMovieDataSource);

      final result = await GetNowPlayingMoviesUseCase(moviesRepository: movieRepository).call();
      print(result);
    });
  }
